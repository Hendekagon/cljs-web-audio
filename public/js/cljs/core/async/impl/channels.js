...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16691 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16691 = (function (val,box,meta16692){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16691.cljs$lang$type = true;
cljs.core.async.impl.channels.t16691.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16691";
cljs.core.async.impl.channels.t16691.cljs$lang$ctorPrWriter = (function (this__3660__auto__,writer__3661__auto__,opt__3662__auto__){return cljs.core._write.call(null,writer__3661__auto__,"cljs.core.async.impl.channels/t16691");
});
cljs.core.async.impl.channels.t16691.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16691.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16693){var self__ = this;
var _16693__$1 = this;return self__.meta16692;
});
cljs.core.async.impl.channels.t16691.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16693,meta16692__$1){var self__ = this;
var _16693__$1 = this;return (new cljs.core.async.impl.channels.t16691(self__.val,self__.box,meta16692__$1));
});
cljs.core.async.impl.channels.__GT_t16691 = (function __GT_t16691(val__$1,box__$1,meta16692){return (new cljs.core.async.impl.channels.t16691(val__$1,box__$1,meta16692));
});
}
return (new cljs.core.async.impl.channels.t16691(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_16694 = self__.takes.pop();if((taker_16694 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16694))
{var take_cb_16695 = cljs.core.async.impl.protocols.commit.call(null,taker_16694);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16695,taker_16694){
return (function (){return take_cb_16695.call(null,null);
});})(take_cb_16695,taker_16694))
);
} else
{}
{
