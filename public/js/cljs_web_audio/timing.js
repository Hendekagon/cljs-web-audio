...
cljs_web_audio.timing.morse_timing = cljs.core.reduce.call(null,(function (m,p__27754){var vec__27755 = p__27754;var c = cljs.core.nth.call(null,vec__27755,0,null);var k = cljs.core.nth.call(null,vec__27755,1,null);return cljs.core.assoc.call(null,m,c,cljs.core.interleave.call(null,cljs.core.map.call(null,(function (d){return new cljs.core.PersistentArrayMap(null, 3, ["-",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [1,3], null),".",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [1,1], null),"_",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0,2], null)], null).call(null,d);
}),cljs.core.name.call(null,k)),cljs.core.repeat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0,1], null))));
}),cljs.core.PersistentArrayMap.EMPTY,cljs_web_audio.timing.morse);
cljs_web_audio.timing.string_to_morse = (function string_to_morse(s){return cljs.core.mapcat.call(null,(function (c){return cljs.core.get.call(null,cljs_web_audio.timing.morse_timing,c,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0,1], null)], null));
}),s.toLowerCase());
});
/**
...
var exp_to_morse__1 = (function (x){return exp_to_morse.call(null,0,cljs.core.concat.call(null,x,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["."], null)));
});
